 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ef="storage";function mI(n,e,t){return n=J(n),LT(n,e,t)}function gI(n){return n=J(n),MT(n)}function _I(n,e){return n=J(n),BT(n,e)}function yI(n=Ao(),e){n=J(n);const r=Fi(n,ef).getImmediate({identifier:e}),i=ml("storage");return i&&jT(r,...i),r}function jT(n,e,t,r={}){qT(n,e,t,r)}function $T(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),i=n.getProvider("app-check-internal");return new Pa(t,r,i,e,Jt)}function zT(){Gt(new Rt(ef,$T,"PUBLIC").setMultipleInstances(!0)),ze(ul,ll,""),ze(ul,ll,"esm2017")}zT();export{mI as A,gI as B,iI as C,eI as D,oI as E,gt as G,Fu as _,pI as a,yI as b,AE as c,GT as d,ZT as e,uI as f,WT as g,cI as h,om as i,fI as j,sI as k,rI as l,XT as m,hy as n,hI as o,nI as p,KT as q,dI as r,lI as s,JT as t,tI as u,YT as v,QT as w,da as x,aI as y,_I as z};
