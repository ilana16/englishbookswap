 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lI(n,e){return J(n).setPersistence(e)}function vE(n,e,t,r){return J(n).onIdTokenChanged(e,t,r)}function TE(n,e,t){return J(n).beforeAuthStateChanged(e,t)}function hI(n,e,t,r){return J(n).onAuthStateChanged(e,t,r)}function dI(n){return J(n).signOut()}const Li="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ef="storage";function mI(n,e,t){return n=J(n),LT(n,e,t)}function gI(n){return n=J(n),MT(n)}function _I(n,e){return n=J(n),BT(n,e)}function yI(n=Ao(),e){n=J(n);const r=Fi(n,ef).getImmediate({identifier:e}),i=ml("storage");return i&&jT(r,...i),r}function jT(n,e,t,r={}){qT(n,e,t,r)}function $T(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),i=n.getProvider("app-check-internal");return new Pa(t,r,i,e,Jt)}function zT(){Gt(new Rt(ef,$T,"PUBLIC").setMultipleInstances(!0)),ze(ul,ll,""),ze(ul,ll,"esm2017")}zT();export{mI as A,gI as B,iI as C,eI as D,oI as E,gt as G,Fu as _,pI as a,yI as b,AE as c,hy as d,JT as e,GT as f,WT as g,ZT as h,om as i,uI as j,cI as k,fI as l,sI as m,rI as n,hI as o,XT as p,KT as q,nI as r,lI as s,dI as t,tI as u,YT as v,QT as w,da as x,aI as y,_I as z};
